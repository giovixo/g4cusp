#ifndef SDDSDDSensitiveDetector_HH
#define SDDSDDSensitiveDetector_HH
...
// G4VSDDSensitiveDetector is the abstract base class for sensitive detectors.

class SDDSensitiveDetector : public G4VSensitiveDetector
{
public:
    SDDSensitiveDetector(G4String SDuniqueName);
