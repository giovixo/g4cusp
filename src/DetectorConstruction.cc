...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    sdd00_log = parser.GetVolume("GAGG001");
    sdd01_log = parser.GetVolume("GAGG002");
    sdd02_log = parser.GetVolume("GAGG003");
    sdd03_log = parser.GetVolume("GAGG004");
    sdd04_log = parser.GetVolume("GAGG005");
    sdd05_log = parser.GetVolume("GAGG006");
    sdd06_log = parser.GetVolume("GAGG007");
    sdd07_log = parser.GetVolume("GAGG008");
    sdd08_log = parser.GetVolume("GAGG009");
    sdd09_log = parser.GetVolume("GAGG010");
    sdd10_log = parser.GetVolume("GAGG011");
    sdd11_log = parser.GetVolume("GAGG012");
    sdd12_log = parser.GetVolume("GAGG013");
    sdd13_log = parser.GetVolume("GAGG014");
    sdd14_log = parser.GetVolume("GAGG015");
    sdd15_log = parser.GetVolume("GAGG016");
    sdd16_log = parser.GetVolume("GAGG017");
    sdd17_log = parser.GetVolume("GAGG018");
    sdd18_log = parser.GetVolume("GAGG019");
    sdd19_log = parser.GetVolume("GAGG020");
    sdd20_log = parser.GetVolume("GAGG021");
    sdd21_log = parser.GetVolume("GAGG022");
    sdd22_log = parser.GetVolume("GAGG023");
    sdd23_log = parser.GetVolume("GAGG024");
    sdd24_log = parser.GetVolume("GAGG025");
    sdd25_log = parser.GetVolume("GAGG026");
    sdd26_log = parser.GetVolume("GAGG027");
    sdd27_log = parser.GetVolume("GAGG028");
    sdd28_log = parser.GetVolume("GAGG029");
    sdd29_log = parser.GetVolume("GAGG030");
    sdd30_log = parser.GetVolume("GAGG031");
    sdd31_log = parser.GetVolume("GAGG032");

    scint00_log = parser.GetVolume("EJ100");
