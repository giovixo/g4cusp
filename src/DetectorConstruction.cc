...
/*	G4Colour white   (1.0, 1.0, 1.0);
    ...
    sdd02_log = parser.GetVolume("LV_Absorber_v003__Meshed_");
    sdd03_log = parser.GetVolume("LV_Absorber_v004__Meshed_");
    sdd04_log = parser.GetVolume("LV_Absorber_v005__Meshed_");
    sdd05_log = parser.GetVolume("LV_Absorber_v006__Meshed_");
    sdd06_log = parser.GetVolume("LV_Absorber_v007__Meshed_");
    sdd07_log = parser.GetVolume("LV_Absorber_v008__Meshed_");
    sdd08_log = parser.GetVolume("LV_Absorber_v009__Meshed_");
    sdd09_log = parser.GetVolume("LV_Absorber_v010__Meshed_");
    sdd10_log = parser.GetVolume("LV_Absorber_v011__Meshed_");
    sdd11_log = parser.GetVolume("LV_Absorber_v012__Meshed_");
    sdd12_log = parser.GetVolume("LV_Absorber_v013__Meshed_");
    sdd13_log = parser.GetVolume("LV_Absorber_v014__Meshed_");
    sdd14_log = parser.GetVolume("LV_Absorber_v015__Meshed_");
    sdd15_log = parser.GetVolume("LV_Absorber_v016__Meshed_");
    sdd16_log = parser.GetVolume("LV_Absorber_v017__Meshed_");
    sdd17_log = parser.GetVolume("LV_Absorber_v018__Meshed_");
    sdd18_log = parser.GetVolume("LV_Absorber_v019__Meshed_");
    sdd19_log = parser.GetVolume("LV_Absorber_v020__Meshed_");
    sdd20_log = parser.GetVolume("LV_Absorber_v021__Meshed_");
    sdd21_log = parser.GetVolume("LV_Absorber_v022__Meshed_");
    sdd22_log = parser.GetVolume("LV_Absorber_v023__Meshed_");
    sdd23_log = parser.GetVolume("LV_Absorber_v024__Meshed_");
    sdd24_log = parser.GetVolume("LV_Absorber_v025__Meshed_");
    sdd25_log = parser.GetVolume("LV_Absorber_v026__Meshed_");
    sdd26_log = parser.GetVolume("LV_Absorber_v027__Meshed_");
    sdd27_log = parser.GetVolume("LV_Absorber_v028__Meshed_");
    sdd28_log = parser.GetVolume("LV_Absorber_v029__Meshed_");
    sdd29_log = parser.GetVolume("LV_Absorber_v030__Meshed_");
    sdd30_log = parser.GetVolume("LV_Absorber_v031__Meshed_");
    sdd31_log = parser.GetVolume("LV_Absorber_v032__Meshed_");

    scint00_log = parser.GetVolume("LV_Scatterer_v1__Meshed_");
    scint01_log = parser.GetVolume("LV_Scatterer_v002__Meshed_");
    scint02_log = parser.GetVolume("LV_Scatterer_v003__Meshed_");
    scint03_log = parser.GetVolume("LV_Scatterer_v004__Meshed_");
    scint04_log = parser.GetVolume("LV_Scatterer_v005__Meshed_");
    scint05_log = parser.GetVolume("LV_Scatterer_v006__Meshed_");
    scint06_log = parser.GetVolume("LV_Scatterer_v007__Meshed_");
    scint07_log = parser.GetVolume("LV_Scatterer_v008__Meshed_");
    scint08_log = parser.GetVolume("LV_Scatterer_v009__Meshed_");
    scint09_log = parser.GetVolume("LV_Scatterer_v010__Meshed_");
    scint10_log = parser.GetVolume("LV_Scatterer_v011__Meshed_");
    scint11_log = parser.GetVolume("LV_Scatterer_v012__Meshed_");
    scint12_log = parser.GetVolume("LV_Scatterer_v013__Meshed_");
    scint13_log = parser.GetVolume("LV_Scatterer_v014__Meshed_");
    scint14_log = parser.GetVolume("LV_Scatterer_v015__Meshed_");
    scint15_log = parser.GetVolume("LV_Scatterer_v016__Meshed_");
    scint16_log = parser.GetVolume("LV_Scatterer_v017__Meshed_");
    scint17_log = parser.GetVolume("LV_Scatterer_v018__Meshed_");
    scint18_log = parser.GetVolume("LV_Scatterer_v019__Meshed_");
    scint19_log = parser.GetVolume("LV_Scatterer_v020__Meshed_");
    scint20_log = parser.GetVolume("LV_Scatterer_v021__Meshed_");
    scint21_log = parser.GetVolume("LV_Scatterer_v022__Meshed_");
    scint22_log = parser.GetVolume("LV_Scatterer_v023__Meshed_");
    scint23_log = parser.GetVolume("LV_Scatterer_v024__Meshed_");
    scint24_log = parser.GetVolume("LV_Scatterer_v025__Meshed_");
    scint25_log = parser.GetVolume("LV_Scatterer_v026__Meshed_");
    scint26_log = parser.GetVolume("LV_Scatterer_v027__Meshed_");
    scint27_log = parser.GetVolume("LV_Scatterer_v028__Meshed_");
    scint28_log = parser.GetVolume("LV_Scatterer_v029__Meshed_");
    scint29_log = parser.GetVolume("LV_Scatterer_v030__Meshed_");
    scint30_log = parser.GetVolume("LV_Scatterer_v031__Meshed_");
    scint31_log = parser.GetVolume("LV_Scatterer_v032__Meshed_");
    scint32_log = parser.GetVolume("LV_Scatterer_v033__Meshed_");
    scint33_log = parser.GetVolume("LV_Scatterer_v034__Meshed_");
    scint34_log = parser.GetVolume("LV_Scatterer_v035__Meshed_");
    scint35_log = parser.GetVolume("LV_Scatterer_v036__Meshed_");
    scint36_log = parser.GetVolume("LV_Scatterer_v037__Meshed_");
    scint37_log = parser.GetVolume("LV_Scatterer_v038__Meshed_");
    scint38_log = parser.GetVolume("LV_Scatterer_v039__Meshed_");
    scint39_log = parser.GetVolume("LV_Scatterer_v040__Meshed_");
    scint40_log = parser.GetVolume("LV_Scatterer_v041__Meshed_");
    scint41_log = parser.GetVolume("LV_Scatterer_v042__Meshed_");
    scint42_log = parser.GetVolume("LV_Scatterer_v043__Meshed_");
    scint43_log = parser.GetVolume("LV_Scatterer_v044__Meshed_");
    scint44_log = parser.GetVolume("LV_Scatterer_v045__Meshed_");
    scint45_log = parser.GetVolume("LV_Scatterer_v046__Meshed_");
    scint46_log = parser.GetVolume("LV_Scatterer_v047__Meshed_");
    scint47_log = parser.GetVolume("LV_Scatterer_v048__Meshed_");
    scint48_log = parser.GetVolume("LV_Scatterer_v049__Meshed_");
    scint49_log = parser.GetVolume("LV_Scatterer_v050__Meshed_");
    scint50_log = parser.GetVolume("LV_Scatterer_v051__Meshed_");
    scint51_log = parser.GetVolume("LV_Scatterer_v052__Meshed_");
    scint52_log = parser.GetVolume("LV_Scatterer_v053__Meshed_");
    scint53_log = parser.GetVolume("LV_Scatterer_v054__Meshed_");
    scint54_log = parser.GetVolume("LV_Scatterer_v055__Meshed_");
    scint55_log = parser.GetVolume("LV_Scatterer_v056__Meshed_");
    scint56_log = parser.GetVolume("LV_Scatterer_v057__Meshed_");
    scint57_log = parser.GetVolume("LV_Scatterer_v058__Meshed_");
    scint58_log = parser.GetVolume("LV_Scatterer_v059__Meshed_");
    scint59_log = parser.GetVolume("LV_Scatterer_v060__Meshed_");
    scint60_log = parser.GetVolume("LV_Scatterer_v061__Meshed_");
    scint61_log = parser.GetVolume("LV_Scatterer_v062__Meshed_");
    scint62_log = parser.GetVolume("LV_Scatterer_v063__Meshed_");
    scint63_log = parser.GetVolume("LV_Scatterer_v064__Meshed_");
