...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    sdd00_log = parser.GetVolume("Absorber_101");
    sdd01_log = parser.GetVolume("Absorber_102");
    sdd02_log = parser.GetVolume("Absorber_103");
    sdd03_log = parser.GetVolume("Absorber_104");
    sdd04_log = parser.GetVolume("Absorber_105");
    sdd05_log = parser.GetVolume("Absorber_106");
    sdd06_log = parser.GetVolume("Absorber_107");
    sdd07_log = parser.GetVolume("Absorber_108");
    sdd08_log = parser.GetVolume("Absorber_109");
    sdd09_log = parser.GetVolume("Absorber_110");
    sdd10_log = parser.GetVolume("Absorber_111");
    sdd11_log = parser.GetVolume("Absorber_112");
    sdd12_log = parser.GetVolume("Absorber_113");
    sdd13_log = parser.GetVolume("Absorber_114");
    sdd14_log = parser.GetVolume("Absorber_115");
    sdd15_log = parser.GetVolume("Absorber_116");
    sdd16_log = parser.GetVolume("Absorber_117");
    sdd17_log = parser.GetVolume("Absorber_118");
    sdd18_log = parser.GetVolume("Absorber_119");
    sdd19_log = parser.GetVolume("Absorber_120");
    sdd20_log = parser.GetVolume("Absorber_121");
    sdd21_log = parser.GetVolume("Absorber_122");
    sdd22_log = parser.GetVolume("Absorber_123");
    sdd23_log = parser.GetVolume("Absorber_124");
    sdd24_log = parser.GetVolume("Absorber_125");
    sdd25_log = parser.GetVolume("Absorber_126");
    sdd26_log = parser.GetVolume("Absorber_127");
    sdd27_log = parser.GetVolume("Absorber_128");
    sdd28_log = parser.GetVolume("Absorber_129");
    sdd29_log = parser.GetVolume("Absorber_130");
    sdd30_log = parser.GetVolume("Absorber_131");
    sdd31_log = parser.GetVolume("Absorber_132");
